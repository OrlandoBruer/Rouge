...
//		g.addEdge(8, 2, 2); g.addEdge(8, 7, 7); g.addEdge(8, 6, 6);
		...
		g.addEdge(2, 5, 1); g.addEdge(5, 2, 1); g.addEdge(5, 8, 1); g.addEdge(8, 5, 1);
		g.addEdge(8, 7, 1); g.addEdge(7, 8, 1); g.addEdge(7, 6, 1); g.addEdge(6, 7, 1);
		g.addEdge(6, 3, 1); g.addEdge(3, 6, 1); g.addEdge(3, 0, 1); g.addEdge(0, 3, 1);
		// without below code = donut, with = all filled in
		g.addEdge(1, 4, 1); g.addEdge(4, 1, 1);
		g.addEdge(4, 3, 1); g.addEdge(3, 4, 1);
		g.addEdge(4, 5, 1); g.addEdge(5, 4, 1);
		g.addEdge(4, 7, 1); g.addEdge(7, 4, 1); 
		
		// Calculate Dijkstra.
		obj.calculate(g.getVertex(4));	
